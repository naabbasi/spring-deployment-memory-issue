...
@Entity
@Table(name = "lookup_verification_type",schema = "indentity_verification")
public class LookUpVerificationType {

    @Id
    @Enumerated(EnumType.STRING)
    private VerificationType absherCode;
    ...
    public VerificationType getAbsherCode() {
        return absherCode;
    }

    public void setAbsherCode(VerificationType absherCode) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LookUpVerificationType)) return false;
        LookUpVerificationType that = (LookUpVerificationType) o;
    ...
    public String toString() {
        return new StringJoiner(", ", LookUpVerificationType.class.getSimpleName() + "[", "]")
